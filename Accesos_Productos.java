...
public class Accesos_Productos {
	...
	public Accesos_Productos(Administradortabla tablaconfigurador) {
		...
		this.iva=iva;
		this.articulo=articulo;
		 this.matriz=tablaconfigurador.getLectura_especial_almacen(ruta);
...
public String [][] getIncrementarPrecio() {
	...
	for(int i=0;i<this.matriz.length;i++) {
		//Cuestion importante me aparecia todo en null y lo que hice fue declarar afuera this.matris =.. y funciono
...
System.out.print("\t¿Que producto desea cambiar? :");
articulo=teclado.nextLine();
	...
	if(encontrado=true) {
		...
		System.out.println("El producto no se encuentra dentro del fichero");
