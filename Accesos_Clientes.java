...
public class Accesos_Clientes {
	...
	public Accesos_Clientes(String nombre, String apellido, String correo, String pais, String ciudad, int telefono, int cp,
			String dni) {
		super();
	...
	public String[][] getModificardatos(int posicion, Administradortabla usuario) {
		...
		System.out.println("¿Cual dato desea modificar? [Nombre, Apellido, Correo, Ciudad, País, Codigo Postal, Telefono, NIF] ");
